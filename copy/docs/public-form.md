...
The hosted form and status page are built on three public endpoints.
You can call them directly — e.g. to build your own branded form on
your website while keeping Suppuo as the inbox.
